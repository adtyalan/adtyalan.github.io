...
const CircularText = ({
  ...
  return (
    <motion.div
      initial={{ rotate: 0 }}
      className={`relative overflow-hidden mx-fit rounded-full w-[100px] h-[100px] text-black dark:text-white font-black text-center cursor-pointer origin-center ${className}`}
      animate={controls}
